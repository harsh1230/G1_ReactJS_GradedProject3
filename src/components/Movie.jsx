...
const Movie = () => {
  ...
  const getMovies = async () => {
    ...
    await axios.get(`${baseUrl}${localStorage.getItem("movie_type")}?id=${localStorage.getItem("movie_id")}`)
      .then((res) => {
  ...
  const el = (
    ...
    <Card loading={loading} title={<Button onClick={() => navigate("/")} type="link">Back to Home</Button>}>
      <Row>
